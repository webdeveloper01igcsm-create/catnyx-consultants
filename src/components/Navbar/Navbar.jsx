...
import { Menu, X, ChevronDown, Calendar, Building2, Briefcase, Home, ShieldCheck, Calculator, FileText, Landmark } from "lucide-react";
                ...
                <div className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="flex flex-roq items-center gap-6">
                        ...
                        <div className="hidden lg:block">
                            <button onClick={onBookAppointment} className="inline-flex items-center gap-2 bg-[#0C69D0] hover:bg-[#0A56AD] text-white text-sm font-semibold px-6 py-2.5 rounded-lg transition-all duration-300">
                                Book Appointment
                            </button>
                        </div>
